...
#define PROJECT_DIR "/home/diman119/Projects/Animations2026/"
...
void application_init(Scene &scene)
{
  ...
  auto material = make_material("character", PROJECT_DIR "sources/shaders/character_vs.glsl", PROJECT_DIR "sources/shaders/character_ps.glsl");
  material->set_property("mainTex", create_texture2d(PROJECT_DIR "resources/MotusMan_v55/MCG_diff.jpg"));

  auto whiteMaterial = make_material("character", PROJECT_DIR "sources/shaders/character_vs.glsl", PROJECT_DIR "sources/shaders/character_ps.glsl");
